...
| プラン | 価格 | 主な機能 |
|--------|------|----------|
| Free | 無料 | 完全ブロック + 使用時刻制限（5件まで） |
| Pro | 月額300円 / 年額2,400円 | 全7制限タイプ + 無制限 + ストリーク |
| Pro Lifetime | 買い切り 4,800円 | Proの永久ライセンス |
| Cloud | 月額500円 / 年額4,800円 | Pro + クラウド同期 |
| Cloud Lifetime | 買い切り 9,800円 | Cloudの永久ライセンス |
